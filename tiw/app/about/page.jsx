    ...
    <div className="bg-zinc-950">
      ...
      <div className="bg-zinc-950 h-screen text-white flex flex-col pt-[10rem] w-[756px] mx-auto">
        ...
        <p className="text-3xl mt-10">
          ...
          We set out to create a <span className = 'text-emerald-400 font-bold'> no nonesense daily task management app</span> that strips away the noise
          ...
          <span className = 'text-emerald-400 font-bold'> distraction-free, minimalist</span> design to keep you focused on getting
          things done.
        </p>
        ...
        <p className="text-3xl mt-10">
          ...
          and functionality, <span className="text-bold text-emerald-400">empowering</span>{" "}
